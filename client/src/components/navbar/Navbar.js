...
const Navbar = () => {
  ...
  return (
    <div className="w-full h-20 sticky top-0 z-50 bg-bodyColor flex justify-between items-center font-titleFont border-b-[1px] border-b-gray-600 px-0">
      <div>
        <img src={logo} alt="logo" />
      </div>
      <div className="hidden md:flex items-center lg:gap-10 mr-3">
